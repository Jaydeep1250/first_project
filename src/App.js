      ...
      <>
        ...
        <Router>
          <Routes>
            ...
            <Route
              path="/rescheduleconfirmpayment"
              element={<ReschedulePayment />}
            />
            <Route path="/cancelpayment" element={<CancelPayment />} />
            <Route path="/faq" element={<FAQ />} />
            <Route
              path="/therapistafterlogindashboard"
              element={<TherapistAfterLoginDashboard />}
            />
      ...
      <>
        ...
        <Router>
          <Routes>
            ...
            <Route
              path="/userregistersignup"
              element={<Enduserregistersignup />}
            />
            <Route path="/resetpassword" element={<Resetpassword />} />
            <Route path="/faq" element={<FAQ />} />
            <Route
              path="/therapistbylanguage"
              element={<TherapistbyLanguage />}
            />
            <Route
              path="/generatepassword"
              element={<TherapistRegisterSignup />}
            />
