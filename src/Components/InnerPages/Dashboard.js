...
const Dashboard = () => {
    ...
    const [bookInfo,setBookInfo] = useState([])
        const booked = () => {
            ...
            //function for reschedual data pass
            ...
            //function for join zoom meeting click on button
            const get_link =(id) => {
                ...
                <div className="col-12 col-sm-12 col-lg-6">
                    ...
                    <div className="therapy_box">
                        <div className="top">
                            ...
                            <div className="col-auto">
                                    <a style={{cursor: "pointer"}} onClick={() => re_appointment(rep.id, rep.therapist_id,rep.session_time,rep.session_date, rep.session_start_time)}  className="link-bold-color">Reschedule Session</a>
                                </div>
                            </div>
