...
const Appointments = () => {
    ...
    const [bookInfo,setBookInfo] = useState([])
        ...
        const booked = () => {
            ...
            const re_appointment = (id, therapist_id, session_time, session_date, session_start_time) =>{
                const UTC = session_date + " " + session_start_time;
                
                 if(new Date().getTime() < new Date(new Date(UTC).setHours(new Date(UTC).getHours() - 24)).getTime()){
                ...
                sessionStorage.setItem("upd_session_date",session_date);
                  window.location.href = '/resechedulesession';  
                     ...
                     alert("You can't Reschedule before 24 hours");
                 }
            }
                                    ...
                                    <div className="top" >
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-auto">
                                                ...
                                                <a style={{cursor: "pointer"}} onClick={() => re_appointment(rep.id, rep.therapist_id,rep.session_time,rep.session_date, rep.session_start_time)} className="link-bold-color"><img src={infocircle} className="mr-2" alt="" />Reschedule Session</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div></div>      
                                ...
                                <div className="therapy_box h-auto">
                                    <div className="top"  >
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-auto">
                                                <a style={{cursor: "pointer"}} onClick={() => re_appointment(rep.id, rep.therapist_id,rep.session_time,rep.session_date)} id={'re_appointment'+ rep.id} className="link-bold-color"><img src={infocircle} className="mr-2" alt="" />Reschedule Session</a>
                                            </div>
