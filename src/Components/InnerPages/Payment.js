...
var user_email = data.email;
   const [book,setBook] = useState([])
        ...
        const booked = () => {
         ...
         //api of choose date and time data
 ...
 // api of data check in zoom table and create zoom meeting
                   ...
                   <div className="row align-items-center mx-5">
                      ...
                      <div className="col-auto">
                         <div className="icon-box">
                            ...
                            <p className="mb-0">
                               {book.book_schedule_date}<br /> {book.book_schedule_time}
                            </p>
                         </div>
                      </div>
                ...
                <div className="row">
                      ...
                      <div className="form-row align-items-baseline">
                         ...
                         <div className="form-group col-sm-12">
                            <div className="checkbox">
                               ...
                               <label for="lang_english"  className="weight-600">Accept the 
                               {cms.map(item=>{
                                  if(item.title == "Terms and Conditions"){
                                 return <a href="pages" onClick={() => get_id_of_cms(item.id)} className="color-txt" key={item.id}> Terms & Conditions </a> 
                   ...
                   <div className="col-md-4 mb-4">
                       <div style={{backgroundColor: '#FFF0DF'}} className="p-4">
                           ...
                           <p>You can Reschedule this appointment within 24hrs of booking, the appointment is non refundable</p>
                       </div>
                   </div>
                </div>
             </div>
