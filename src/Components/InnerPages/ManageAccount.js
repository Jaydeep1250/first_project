        ...
        const togglePassword =()=>{
         ...
         function submit1() {
           ...
           const PassUpdate = (user_id, old_password, new_password) => {
            ...
            const card_error =  response.data.message;
                         ...
                         <div className="row">
                             <div className="col-md-8">
                                 ...
                                 <div className="form-group input-box col-sm-6">
                                         ...
                                         <input type="text" maxLength="30" className="form-control" value={values1.f_name} onChange={handleChange1} name="f_name" id="f_name" placeholder="Your First Name here" />
                                     ...
                                     <div className="form-group col-sm-12">
                                         ...
                                         <input type="submit" value="Submit" className="btn gradient-btn px-5" />
                                             ...
                                             <div className="col-auto mb-3">
                                         <input type="button" onClick={cancelbutton} value="Cancel" className="btn pink-border-btn px-5" />
                                             </div>
                                         </div>
                                     </div>
                                 </div>
...
function alert_msg(card_error) {
    ...
    var html = '';
    html += '<div class="alert alert-danger  alert-dismissible fade show" id="alert_success" style="width: 113%;margin-left: 20px;" role="alert">';
