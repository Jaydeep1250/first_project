...
const Therapists = () => {
  ...
  // filters of search functionality
  ...
  // api call for scheduale time
  const [time, setTime] = useState([]);

  const fetchTime = (therapist_id, schedule_date) => {
    if (schedule_date) {
      $(".schedule_date").removeClass("active");
      $("#schedule_date_" + therapist_id + "_" + schedule_date).addClass(
        "active"
      );
      let item = { date: schedule_date, therapist_id: therapist_id };
      axios
        .post(globeVar + "therapist/schedule_list/get_schedule_by_date", item)
        .then((response) => {
          if (response.data.success === 1) {
            ...
            timeArray.country = myArray_date;
            timeArray.schedule_date = myArray_date;
            
            console.log("hii");
            console.log(response);
            console.log(myArray.timezone);
            setTime(timeArray);
          } else {
            Swal.fire({
              icon: "error",
  ...
  useEffect(() => {
    const filtered = word.filter((value) => {
      if (searchTerm.length < 3) {
        ...
        value.therapist_type.toLowerCase().includes(searchTerm.toLowerCase()) ||
        value.l_name.toLowerCase().includes(searchTerm.toLowerCase())
      ) {
        return value;
      } else if (!value) {
        return <span>NO</span>;
    ...
    <div>
        ...
        <div className="container section-padding pb-0">
          <div className=" mb-3 mb-md-4">
            <div className="align-items-center row">
              <h3 className="col mb--4 mb-md-0 title d-none d-md-block">
                Find A ShivYog Therapist
              </h3>
            ...
            <div className="align-items-center form-row">
              ...
              <div className="col-auto  ">
                <div className="dropdown">
                  <a
                    className="btn dropdown-btn dropdown-toggle w-100 text-left"
                    href="#"
                    id="languageDropdown"
                    role="button"
                  ...
                  <div
                    className="dropdown-menu click-open"
              ...
              <div className="col col-md-auto  ">
                <div className="dropdown">
                  ...
                  <div
                    className="dropdown-menu click-open"
                    aria-labelledby="therapyTypeDropdown"
                  >
                    <div className="dropdown-box px-2">
                      <div className="checkbox">
                        <input
                          type="checkbox"
                          value="ShivYog Master Cosmic Therapist"
                          onChange={(e) => handleCheck()}
                          name="therapyType"
                          id="therapyType1"
                        />
                        <label for="therapyType1">
                          ShivYog Master Cosmic Therapist
                        </label>
                      </div>
                      <div className="checkbox">
                        <input
                          type="checkbox"
                          value="ShivYog Master Cognitive Therapist"
                          onChange={(e) => handleCheck()}
                          name="therapyType"
                          id="therapyType2"
                        />
                        <label for="therapyType2">
                          ShivYog Master Cognitive Therapist
                        </label>
                      </div>
                      <div className="checkbox">
                        <input
                          type="checkbox"
                          value="ShivYog Cosmic Therapist"
                          onChange={(e) => handleCheck()}
                          name="therapyType"
                          id="therapyType3"
                        />
                        <label for="therapyType3">
                          ShivYog Cosmic Therapist
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="dropdown-box">
                      <a
                        ...
                        onClick={(e) =>
                          handleCheck("Years of ShivYog Therapy Experience")
                        }
                      >
                        Years of ShivYog Therapy Experience
                      </a>
                      <a
                        className="dropdown-item"
                        onClick={(e) => handleCheck("Later Date Availability")}
                      >
                        Later Date Availability
                      </a>
                      <a
                        className="dropdown-item"
                        onClick={(e) => handleCheck("Fee Low To High")}
                      >
                        Fee – Low To High
                      </a>
                      <a
                        className="dropdown-item"
                        onClick={(e) => handleCheck("Fee High To Low")}
                      >
                        Fee – High To Low
                      </a>
                    </div>
      ...
      <section>
        <div className="container section-padding pt-0">
          <div className="form-row therapist" id="accordionExample">
            {results.length > 0 ? (
                    ...
                    <div className="col-12 col-sm-12 col-md-12">
                      <div className="therapy_box bg-pink">
                          ...
                          <div className="row">
                            ...
                            <div className="col-auto">
                              <div className="d-flex align-items-center">
                                ...
                                <span className="badge hour-badge float-right">
                          ...
                          <div className="row">
                            <div className="user-box col">
                              <img
                                ...
                                alt=""
                                className="user-img profile_image"
                              />
                              <p className="name-lg">
                            ...
                            <div className="col-auto">
                              <div className="icon-box">
                                <span
                                  className="icon tooltip-bottom"
                                  data-tooltip="Languages Therapist Speaks"
                                >
                            ...
                            <div className="col-auto">
                              <a
                                href="#"
                                id={"hide_session_" + item.user_id}
                                onClick={() => fetchData(item.user_id)}
                                className="btn gradient-btn collapsed hide_session"
                                data-toggle="collapse"
                                data-target={"#collapseOne" + item.user_id}
                                aria-expanded="true"
                              ...
                              <a
                                href="/login"
                                id={"hide_book_" + item.user_id}
                                style={{ display: "none" }}
                                className="btn gradient-btn booking"
                              >
                                Book
                              </a>
                            </div>
                        ...
                        <div
                          ...
                          className="collapse session-book-box"
                          ...
                          <div className="card-body">
                            <div className="session-scroller">
                              ...
                              <div className="session-dates" id="foo">
                                {nodata.success == 1 ? clocks.map((items) => {
            ...
            <div className="col-12 text-center">
              <a
                className="btn border-btn w-auto px-3"
                id="loadMore"
                onClick={() => showMoreTherapist()}
              >
                VIEW MORE
              </a>
            </div>
...
//function for give class and store date, time and therapist_id
function hidesession(id, session, therapist_id) {
  ...
  var hd = document
    .getElementById("myDIV_" + therapist_id + "_" + id)
